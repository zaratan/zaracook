  ...
  <StaticQuery
    ...
    render={data => (
      <Wrapper data-testid="navigation">
        ...
        <SocialMedia>
          <a href="https://www.twitter.com/zaratan" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
            <FaTwitter />
          </a>
          <a href="https://www.facebook.com/zaratan" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <FaFacebook />
          </a>
          <a href="https://github.com/denispasin" target="_blank" rel="noopener noreferrer" aria-label="Github">
            <FaGithub />
          </a>
        </SocialMedia>
      </Wrapper>
